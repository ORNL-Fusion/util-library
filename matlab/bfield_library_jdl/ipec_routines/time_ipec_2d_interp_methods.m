...
tic;
for i = 1:ntry
    interp2(ipec.eq.r(:,1),ipec.eq.z(1,:),ipec.eq.br.',R,Z)
end
fprintf('This took %f\n',toc)
...
for i = 1:ntry
    ...
    Q11 = ipec.eq.br(ir  ,iz);
    Q12 = ipec.eq.br(ir  ,iz+1);
    Q21 = ipec.eq.br(ir+1,iz);
    Q22 = ipec.eq.br(ir+1,iz+1);
