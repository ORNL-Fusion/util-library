function [s,ierr,i_last_good]=follow_fieldlines_rz_dlp(bfield,Rstart,Zstart,dlp,nsteps,nowarn)
% [s,ierr,i_last_good]=follow_fieldlines_rz_dlp(bfield,Rstart,Zstart,dlp,nsteps,nowarn)
% AS assumed!
...
[yout,xout,ierr_rk45,i_last_good] = rk45_fixed_step_integrate_dlp(y,x,dx,nsteps,bfield,nowarn);
